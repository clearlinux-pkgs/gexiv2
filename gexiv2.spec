...
Source0  : https://download.gnome.org/sources/gexiv2/0.14/gexiv2-0.14.5.tar.xz
...
%prep
%setup -q -n gexiv2-0.14.5
cd %{_builddir}/gexiv2-0.14.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748358790
