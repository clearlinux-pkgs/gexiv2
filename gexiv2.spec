...
Source0  : https://download.gnome.org/sources/gexiv2/0.14/gexiv2-0.14.2.tar.xz
...
%prep
%setup -q -n gexiv2-0.14.2
cd %{_builddir}/gexiv2-0.14.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698794285
